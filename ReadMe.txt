...
TODO:
1. Должны работать все кнопки в плейере;
2. При выходе из плейера плейлист должен сохраняться, а при запуске плейера, загружаться;
3. В плейлисте должна подсвечиваться активная композиция;
4. При двойном щелчке по композиции в плейлисте должно начинаться ее воспроизведение;
5. Добавить возможность зацикливать плейлист, и включать режим перемешивания;
6. Добавить кнопку 'CLR', которая очищает плейлист;
7. Добавить кнопку 'DEL', которая удаляет выбранные композиции из плейлиста;
